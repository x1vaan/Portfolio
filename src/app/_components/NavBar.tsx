          ...
          <ul className="flex flex-row gap-3 md:gap-5 items-center" aria-label="Social media">
            <li className="text-xs shrink-0">
              <a className="block text-slate-500/40 hover:text-slate-400 transition ease-in-out delay-50" href="https://github.com/x1vaan" target="_blank" title="GitHub">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-5 md:size-6" aria-hidden="true">
            ...
            <li className="text-xs shrink-0">
              <a
                className="block text-slate-500/40 hover:text-slate-400 transition ease-in-out delay-50"
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5 md:size-6" aria-hidden="true">
            ...
            <li className="text-xs shrink-0">
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" fill="currentColor" className="size-5 md:size-6" aria-hidden="true">
