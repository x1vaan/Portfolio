...
const StrapiSVG: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" width="256" height="256" preserveAspectRatio="xMidYMid" {...props}>
      <path
        fill="#4945FF"
